...
public class OrderVo extends Order{
    ...
    public OrderVo(String goods_id, String emp_id, String seller_emp_id, String address_id, String goods_count, String payable_amount, String distribution_type, String distribution_status, String postscript, String invoice, String invoice_title, String taxes, String provinceId, String cityId, String areaId, String empCover) {
        super(goods_id, emp_id, seller_emp_id, address_id, goods_count, payable_amount, distribution_type, distribution_status, postscript, invoice, invoice_title, taxes, provinceId, cityId, areaId);
        this.empCover = empCover;
    }
}
