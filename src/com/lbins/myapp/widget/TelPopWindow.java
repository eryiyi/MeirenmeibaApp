 ...
 * 类的功能、说明写在此处.
 */
public class TelPopWindow extends PopupWindow {


    private TextView btn_cancle, btn_sure;
    private View mMenuView;

    public TelPopWindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.tel_pop_view, null);
