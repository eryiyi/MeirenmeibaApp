...
import com.lbins.myapp.adapter.GoodsTypeIndexAdapter;
...
public class MoreGoodsTypeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        adaptertype = new GoodsTypeIndexAdapter(listGoodsType, MoreGoodsTypeActivity.this);
                ...
                if(listGoodsType.size()>(position)){
                    ...
                    if(goodsType != null){
                        if("0".equals(goodsType.getTypeId())){
                            //更多
                            Intent intent = new Intent(MoreGoodsTypeActivity.this, SearchMoreTypeActivity.class);
