                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code) == 200) {
                                    ...
                                    switch (Integer.parseInt(code)){
                                        case 1:
                                            showMsg(FindPwrMobileActivity.this, "找回密码失败，请稍后重试！");
                                            break;
                                        case 2:
                                            showMsg(FindPwrMobileActivity.this, "手机号为空！");
                                            break;
                                        case 3:
                                            showMsg(FindPwrMobileActivity.this, "密码为空！");
                                            break;
                                        case 4:
                                            showMsg(FindPwrMobileActivity.this, "请确认该手机号是否已经注册！");
                                            break;
                                    }
                                }
                            ...
                            Toast.makeText(FindPwrMobileActivity.this, R.string.add_failed, Toast.LENGTH_SHORT).show();
                        }
                        if(progressDialog != null){
                            progressDialog.dismiss();
                        }
