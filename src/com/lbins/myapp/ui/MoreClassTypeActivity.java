 ...
 * 更多商户分类
 */
public class MoreClassTypeActivity extends BaseActivity implements View.OnClickListener {
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (code1 == 200) {
                                    ...
                                    Toast.makeText(MoreClassTypeActivity.this, jo.getString("message"), Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                            ...
                            Toast.makeText(MoreClassTypeActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                        }
    ...
    private void initView() {
        ...
        adaptertype = new IndexTypeAdapter(listGoodsType, MoreClassTypeActivity.this);
        ...
        gridv_one.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(listGoodsType.size()>(position)){
                    LxClass goodsType = listGoodsType.get(position);
                    if(goodsType != null){
