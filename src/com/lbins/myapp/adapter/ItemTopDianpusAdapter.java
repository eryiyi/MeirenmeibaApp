 ...
 * 商品详情页店铺列表
 */
public class ItemTopDianpusAdapter extends BaseAdapter {
    private ViewHolder holder;
    private List<PaihangDianpu> lists;
    ...
    public ItemTopDianpusAdapter(List<PaihangDianpu> lists, Context mContect) {
        this.lists = lists;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        PaihangDianpu cell = lists.get(position);
        if (cell != null) {
