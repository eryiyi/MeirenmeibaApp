...
public class GridClassViewAdapter extends BaseAdapter {
	...
	private ArrayList<LxClass> list;
	private LxClass type;
	private Context context;
	Holder view;

	public GridClassViewAdapter(Context context, ArrayList<LxClass> list) {
		this.list = list;
...
//					type.getIcon()));
			view.name.setText(type.getLx_class_name());
		}
