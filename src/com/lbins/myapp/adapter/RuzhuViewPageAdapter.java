 ...
 * 入驻申请
 */
public class RuzhuViewPageAdapter extends PagerAdapter {

    private ApplyDianpuActivity context;

    private JSONArray jsonArray;

    private Map<Integer, ViewPageItemView> hashMap;

    public RuzhuViewPageAdapter(ApplyDianpuActivity context, JSONArray jsonArray) {
