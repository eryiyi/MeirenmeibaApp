package com.lbins.myapp.receiver;
...
//        updateContent(context, responseString);
    ...
    private void updateChanelId(final Context context, String channelId, final String pushId) {
        ...
        String uri = String.format(InternetURL.UPDATE_PUSH_ID + "?id=%s&pushId=%s&channelId=%s&type=3", empId, pushId, channelId);
